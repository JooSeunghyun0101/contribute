...
const ScoreDisplay: React.FC<ScoreDisplayProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl border border-primary/20 p-4 sm:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          {contributionScope && (
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="text-center flex flex-col justify-center h-20 cursor-help">
                  <div className="text-xs sm:text-sm text-muted-foreground font-medium mb-2">기여범위</div>
                  <div className="flex items-center justify-center gap-2">
          ...
          <div className="text-center flex flex-col justify-center h-20">
            <div className="text-xs sm:text-sm text-muted-foreground font-medium mb-2">기본점수</div>
            <div className="text-xl sm:text-2xl font-bold text-primary">{score}점</div>
          </div>

          {/* Weighted Score */}
          <div className="text-center flex flex-col justify-center h-20">
            <div className="text-xs sm:text-sm text-muted-foreground font-medium mb-2">가중치적용</div>
