...
## 샘플 데이터 — 운영 DB 투입 금지 (5개 + 스크립트 1개)

`employees_rows.sql` · `evaluations_rows.sql` · `tasks_rows.sql` ·
`feedback_history_rows.sql` · `notifications_rows.sql` ·
`reconstruct_sample_2025_2026.cjs` (샘플 재구성 스크립트, DRY_RUN 기본)
