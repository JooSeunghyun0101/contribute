...
- **evaluatee** (예: `H1000007`) — 사이드바 4메뉴, Gantt, 피드백 카드, AddTask 모달
- **evaluator** (예: `H1000002`) — 5메뉴, 팀 3명 표시, Score 테이블 T01-T04 + 평균, `/evaluation/:id` 이동
- **hr** (예: `H1000001`) — 5메뉴, 부서 카드 진행률, 사용자 검색/필터, 설정 섹션 저장
