...
window.OK_MOCK = (() => {
  const employees = [
    { id: 'H1000001', name: '홍길동', position: '이사', dept: '인사부', level: null, role: 'hr' },
    { id: 'H1000002', name: '김철수', position: '부장', dept: '인사기획팀', level: 4, role: 'evaluator' },
    { id: 'H1000003', name: '이영희', position: '차장', dept: '인사팀',    level: 3, role: 'evaluator' },
    { id: 'H1000004', name: '박민수', position: '차장', dept: '인사기획팀', level: 3, role: 'evaluatee' },
    { id: 'H1000006', name: '최지우', position: '차장', dept: '인사팀',    level: 3, role: 'evaluatee' },
    { id: 'H1000005', name: '정수진', position: '차장', dept: '인사기획팀', level: 3, role: 'evaluatee' },
    { id: 'H1000007', name: '강하늘', position: '대리', dept: '인사기획팀', level: 2, role: 'evaluatee' },
    { id: 'H1000008', name: '윤서연', position: '대리', dept: '인사팀',    level: 2, role: 'evaluatee' },
    { id: 'H1000009', name: '임도현', position: '대리', dept: '인사팀',    level: 2, role: 'evaluatee' },
    { id: 'H1000010', name: '한가은', position: '사원', dept: '인사팀',    level: 1, role: 'evaluatee' },
  ];

  // 평가자-피평가자 매핑
  const evaluatorMap = {
    'H1000002': ['H1000004','H1000005','H1000007'],
    'H1000003': ['H1000006','H1000008','H1000010','H1000009'],
    'H1000001': ['H1000002','H1000003'],
  };

  // 피평가자별 과업 (현재 로그인: 강하늘 H1000007 가정)
  const myTasks = [
    {
      id: 'T001',
      ...
      feedbackDate: '2026-04-20', evaluator: '김철수',
      history: [
        { id: 'F1', evaluator: '김철수', date: '2026-04-20', content: '체계 전환 과제를 주도적으로 이끌었고, 현업 인터뷰 20회 이상을 진행해 실행 가능한 정책으로 만들었습니다.' },
        { id: 'F2', evaluator: '김철수', date: '2026-03-12', content: '중간 점검 결과 일정 대비 20% 앞서 진행 중. 타 팀 협업에서도 주도적 태도가 인상적.' },
      ],
    },
    {
      id: 'T002',
      ...
      feedbackDate: '2026-04-05', evaluator: '김철수',
      history: [
        { id: 'F3', evaluator: '김철수', date: '2026-04-05', content: '교육 프로그램의 구조는 좋았으나 평가자 그룹 대상 심화 세션이 부족했던 점 아쉬움.' },
      ],
    },
    {
      id: 'T003',
      ...
      feedbackDate: '2026-04-18', evaluator: '김철수',
      history: [
        { id: 'F4', evaluator: '김철수', date: '2026-04-18', content: '요구사항 정리가 깔끔했음. BI팀 리드의 피드백도 긍정적.' },
      ],
    },
    {
      id: 'T004',
  ...
  const notifications = [
    { id: 'N1', type: 'feedback_added', title: '새로운 피드백이 도착했습니다',
      message: '김철수 부장님이 \'기여도 평가 시스템 사용자 온보딩\' 과업에 피드백을 남겼습니다.',
      from: '김철수', time: '방금 전', read: false, priority: 'high' },
    { id: 'N2', type: 'evaluation_completed', title: '평가가 완료되었습니다',
      message: '박민수 차장의 2026년 상반기 기여도 평가가 최종 확정되었습니다. 총점 3.4점/Lv.3.',
    ...
    { id: 'N6', type: 'feedback_added', title: '피드백 이력 업데이트',
      ...
      from: '김철수', time: '3일 전', read: true, priority: 'medium' },
  ];
  ...
  return {
    ...
    // 편의 접근
    currentUser: { id: 'H1000007', name: '강하늘', position: '대리', dept: '인사기획팀', level: 2 },
    evaluatorUser: { id: 'H1000002', name: '김철수', position: '부장', dept: '인사기획팀', level: 4 },
    hrUser: { id: 'H1000001', name: '홍길동', position: '이사', dept: '인사부', level: 5 },
  };
})();
